...
public final class LinkedListApplication
{
	public static void main(String args[])
	{
		...
		System.out.println("Enter 1 for search, 2 for insertion, 3 for deletion, 4 for append, 5 for remove, 6 for Average, 7 for deleting max node");
		...
		while (s == 1 || s == 2 || s == 3 || s == 4 || s == 5 || s==6 || s == 7)
		{
			...
			if (s == 7) {
				linkedList.SearchNodeWithLargestKey();
				System.out.println("The new Node is");
				linkedList.ShowLinkedList();
			};
