...
public class SortedArrayApplication {
	...
	public static void main(String[] args) {
		...
		SortedArrayAccess arrApp = new SortedArrayAccess(capacity);
		...
		while(s!=1 || s!=2 || s!=3 || s!=4 || s!=5) {
			System.out.println("Enter 1 for search, 2 for insert, 3 for delete, 4 for remove, 5 for exit");
			...
			while (s == 1 || s == 2 || s == 3 || s == 4 || s == 5)
			{
				...
				if (s == 2)
				{
					if(arrApp.currentSize == capacity)
					{
				...
				System.out.println("Enter 1 for search, 2 for insertion, 3 for delete, 4 for remove, 5 for exit");
				s = Integer.parseInt(new Scanner(System.in).nextLine());
			}
			//System.out.println("Goodbye!");
		}
